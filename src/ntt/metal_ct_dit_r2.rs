...
/// Generate twiddle factors matching the CPU reference exactly.
/// Layer i has n/(2^(i+1)) twiddles, using x-coordinates of coset points
/// (y-coordinates for the last layer to avoid x=0).
